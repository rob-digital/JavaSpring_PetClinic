...
import guru.springframework.javaspring_petclinic.model.*;
import guru.springframework.javaspring_petclinic.services.OwnerService;
import guru.springframework.javaspring_petclinic.services.PetTypeService;
...
public class DataLoader implements CommandLineRunner {
    ...
    private void loadData() {
        ...
        owner1.setAddress("123 Miami Beach");
        owner1.setCity("Miami");
        owner1.setTelephone("423525");
        ...
        owner2.setAddress("23423 Some Avenue");
        owner2.setCity("Chicago");
        owner2.setTelephone("5456546");

        Pet fionasCat = new Pet();
        fionasCat.setName("Little Kitty");
